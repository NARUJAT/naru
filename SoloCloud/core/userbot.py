...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("all_about_naru")
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("all_about_naru")
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("all_about_naru")
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("all_about_naru")
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("all_about_naru")
        ...
        if config.STRING6:
            ...
            try:
                await self.six.join_chat("all_about_naru")
        ...
        if config.STRING7:
            ...
            try:
                await self.seven.join_chat("all_about_naru")
